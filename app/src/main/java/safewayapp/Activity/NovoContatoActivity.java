...
public class NovoContatoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //BrPhoneNumberFormatter addLineNumberFormatter = new BrPhoneNumberFormatter(new WeakReference<EditText>(txtTelefoneContato));
        //txtTelefoneContato.addTextChangedListener(addLineNumberFormatter);
...
class BrPhoneNumberFormatter implements TextWatcher {
